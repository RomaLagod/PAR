...
type
  TPara_Normal = class(TForm)
    ...
    procedure mmPrintOptionClick(Sender: TObject);
  private
...
procedure TPara_Normal.tbPrintClick(Sender: TObject);
begin
ReportPar.QuickRep1.PreviewModal;
end;

procedure TPara_Normal.mmPrintClick(Sender: TObject);
begin
ReportPar.QuickRep1.PreviewModal;
end;

procedure TPara_Normal.mmPrintOptionClick(Sender: TObject);
begin
ReportPar.QuickRep1.PreviewModal;
end;
