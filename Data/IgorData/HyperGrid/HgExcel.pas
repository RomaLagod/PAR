...
{
AutoFit Method
Changes the width of the columns in the range
or the height of the rows in the range to achieve the best fit.
...
expression   Required. An expression that returns a Range object.
						 Must be a row or a range of rows, or a column or a range of columns.
...
This example changes the width of columns A through E on Sheet1 to achieve the best fit,
based only on the contents of cells A1:E1.
