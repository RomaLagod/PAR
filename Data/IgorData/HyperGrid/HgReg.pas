...
uses Classes , HgGrid , HgColumn , HgProp , DesignIntf, DesignEditors , HgColors,HyperImageGrid;

procedure Register;
begin
  RegisterComponents( 'User' , [ THyperGrid ] );
  RegisterComponents( 'User' , [ THyperImageGrid]);
