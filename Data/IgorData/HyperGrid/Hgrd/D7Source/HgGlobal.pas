...
type
	...
	// Control types
	ThgControlType = ( hgctlComboBox , hgctlButton {start Tsoyran}, hgctlCheckBox {end Tsoyran});
	ThgControlTypes = set of ThgControlType;
// start Tsoyran
	// Check Styles
	ThgBooleanType  	= ( hgcbtCheckBox, hgcbtRadio, hgcbtString );
	ThgFormatTextType = ( hgfmtAsEntered , hgfmtAsLowered, hgfmtAsUpcase, hgfmtAsName);
// end Tsoyran
	// Vertical alignment
...
var
  hgDateFormats: array [ hgdoMDY..hgdoYMD , 0..10 ] of string =
	(
		( 'm/d' , 'm/d/yyyy' , 'mm/dd/yyyy' , 'd-mmm' , 'd-mmm-yyyy' , 'dd-mmm-yyyy' ,
			'mmm-yyyy' , 'mmmm-yyyy' , 'mmmm d, yyyy' , 'ddd mmmm d, yyyy' ,
			'dddd mmmm d, yyyy' ),
		( 'd/m' , 'd/m/yyyy' , 'dd/mm/yyyy' , 'd-mmm' , 'd-mmm-yyyy' , 'dd-mmm-yyyy' ,
			'mmm-yyyy' , 'mmmm-yyyy' , 'mmmm d, yyyy' , 'ddd mmmm d, yyyy' ,
			'dddd mmmm d, yyyy' ),
		( 'm/d' , 'yyyy/m/d' , 'yyyy/mm/dd' , 'd-mmm' , 'd-mmm-yyyy' , 'dd-mmm-yyyy' ,
			'mmm-yyyy' , 'mmmm-yyyy' , 'mmmm d, yyyy' , 'ddd mmmm d, yyyy' ,
      'dddd mmmm d, yyyy' )
  );
...
//  hgDefaultControlType = ThgControlTypes( [] );
	...
	// start tsoyran
	hgDefaultCheckInteger	= 1;
	hgDefaultCheckStyle   = hgcbtCheckBox;
	hgDefaultYesString		= 'Yes';
	hgDefaultNoString			= 'No';
	hgDefaultFormatText		= hgfmtAsEntered;
	// end  tsoyran
